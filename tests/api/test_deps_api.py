"""Tests for app.api.deps.require_public_namespace, via the /public routes
that depend on it (there is no standalone route that returns its raw dict,
so we assert its gating behavior indirectly through app.api.public, plus a
couple of direct unit-style calls against a real sqlite fixture)."""
